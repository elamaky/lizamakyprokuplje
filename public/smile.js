...
<div id="smileModal" style="display:none; position:fixed; width:900px; background:black; padding:10px; border:1px solid white; z-index:1000; overflow:auto; border-radius:5px; color:white; flex-wrap:wrap; max-height:600px;">
    <button onclick="closeSmileModal()" style="position:absolute; top:10px; right:10px; background:red; color:white; border:none; padding:5px 10px; cursor:pointer;">
        X
    </button>
